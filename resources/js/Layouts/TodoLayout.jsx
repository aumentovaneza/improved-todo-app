...
export default function TodoLayout({ header, children }) {
    ...
    return (
        <div className="min-h-[100dvh] min-w-0 max-w-full overflow-x-hidden bg-light-primary dark:bg-dark-primary lg:flex">
            ...
            {/* Main Content Area */}
            <div className="flex min-h-[100dvh] min-w-0 max-w-full flex-1 flex-col lg:ml-64">
                {/* Top Navigation Bar */}
                ...
                {/* Page Content */}
                <main className="min-w-0 max-w-full flex-1 overflow-x-hidden px-4 py-6 pb-28 sm:px-6 lg:pb-6">
